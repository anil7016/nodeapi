...
const maintainanceController = require('@/controllers/appControllers/maintainanceController');
...
// ----- maintanance Api ----------//
router
  .route('/maintanance/create')
  .post(hasPermission('create'), catchErrors(maintainanceController.create));
router
  .route('/maintanance/read/:id')
  .get(hasPermission('read'), catchErrors(maintainanceController.read));
router
  .route('/maintanance/update/:id')
  .patch(hasPermission('update'), catchErrors(maintainanceController.update));
router
  .route('/maintanance/update/:id')
  .patch(hasPermission('update'), catchErrors(maintainanceController.update));
router
  .route('/maintanance/delete/:id')
  .delete(hasPermission('delete'), catchErrors(maintainanceController.delete));
router
  .route('/maintanance/search')
  .get(hasPermission('read'), catchErrors(maintainanceController.search));
router
  .route('/maintanance/list')
  .get(hasPermission('read'), catchErrors(maintainanceController.list));
router
  .route('/maintanance/filter')
  .get(hasPermission('read'), catchErrors(maintainanceController.filter));
